...
class AppColors {
  static const Color backgroundColor = Color(0xFFEDF2F6); // Màu nền Telegram
...
class AppSizes {
  ...
  static const double spacingMedium = 30.0; // Khoảng cách trung bình
  static const double spacingSmall = 20.0; // Khoảng cách nhỏ
}